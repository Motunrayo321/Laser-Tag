...
<html>
  <head>
    ...
    <style>
        ...
        .team select:hover { border-color: #218838; }
        .team select:focus { outline: none; box-shadow: 0 0 5px #28a745; }
...
void setup() {
  ...
  server.on("/register", HTTP_GET, [](AsyncWebServerRequest *request){
    ...
    if (request->hasParam("teams")) {
      playerTeam = request->getParam("teams")->value();
    }
